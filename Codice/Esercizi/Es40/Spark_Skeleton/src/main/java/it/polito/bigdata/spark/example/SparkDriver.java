...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		/** Ex. 40: Order sensors by number of critical days
		 ...
		 * Output: an HDFS file containing the sensor ordered by the number of critical days
		 * 	Each line of the output files contains the number of days with a PM10 value greater than 
		 * 	50 for a sensor s and it's sensorID.
		...
		critSenRDD.saveAsTextFile(outputPath);
