...
public class DriverBigData extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		*/
		...
		numberOfReducersJob1 = Integer.parseInt("1");
		inputPath = new Path("InputFolder");
		outputDir = new Path("OutputFolder");
		...
		if (job.waitForCompletion(true) == true) { 
			...
			outputDir2 = new Path("OutputFolderDef");
			...
			job2.setOutputValueClass(WordCountWritable.class);
